...
if (len(args) != 3 and len(args) != 4):
    print(len(args))
    print(args)
    print("Incorrect number of arguments! Please pass Name of the algorithm, number of action steps of training, name of the output file and optionaly name of the model you wish to continue training")
    exit()
